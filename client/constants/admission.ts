import { ADMISSION_TYPE, DSESubjectId } from "../types/common"
...
const CategoryA = [
  { value: DSESubjectId.CHINESE_LANGUAGE, title: "中國語文" },
  { value: DSESubjectId.ENGLISH_LANGUAGE, title: "英國語文" },
  { value: DSESubjectId.MATHEMATICS_COMPULSORY_PART, title: "數學必修部分" },
  {
    value: DSESubjectId.CITIZENSHIP_AND_SOCIAL_DEVELOPMENT,
    title: "公民與社會發展"
  },
  { value: DSESubjectId.LIBERAL_STUDIES, title: "通識教育" },
  { value: DSESubjectId.BIOLOGY, title: "生物" },
  { value: DSESubjectId.CHEMISTRY, title: "化學" },
  { value: DSESubjectId.ECONOMICS, title: "經濟" },
  {
    value: DSESubjectId.BUSINESS_ACCOUNTING_AND_FINANCIAL_STUDIES,
    title: "企業、會計與財務概論"
  },
  { value: DSESubjectId.PHYSICAL_EDUCATION, title: "物理" },
  { value: DSESubjectId.GEOGRAPHY, title: "地理" },
  { value: DSESubjectId.M1, title: "M1" },
  ...
  { value: DSESubjectId.VISUAL_ARTS, title: "視覺藝術" },
  { value: DSESubjectId.CHINESE_LITERATURE, title: "中國文學" },
  { value: DSESubjectId.PHYSICAL_EDUCATION, title: "體育" },
  {
    value: DSESubjectId.HEALTH_MANAGEMENT_AND_SOCIAL_CARE,
    title: "健康管理與社會關懷"
  },
  { value: DSESubjectId.ETHICS_AND_RELIGIOUS_STUDIES, title: "倫理與宗教" },
  {
    value: DSESubjectId.DESIGN_AND_APPLIED_TECHNOLOGY,
    title: "設計與應用科技"
  },
  { value: DSESubjectId.COMBINED_SCIENCE, title: "組合科學" },
  { value: DSESubjectId.LITERATURE_IN_ENGLISH, title: "英語文學" },
  { value: DSESubjectId.TECHNOLOGY_AND_LIVING, title: "科技與生活" },
  { value: DSESubjectId.MUSIC, title: "音樂" },
  { value: DSESubjectId.INTEGRATED_SCIENCE, title: "綜合科學" }
]
